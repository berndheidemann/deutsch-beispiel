...
export const metrumKlopferVerseReihe = [
  ...
  },
  {
    id: 'trakl-verfall',
    silben: [
      { text: 'Am', betont: false },
      { text: 'A', betont: true },
      { text: 'bend,', betont: false },
      { text: 'wenn', betont: false },
      { text: 'die', betont: false },
      { text: 'Glo', betont: true },
      { text: 'cken', betont: false },
      { text: 'Frie', betont: true },
      { text: 'den', betont: false },
      { text: 'läu', betont: true },
      { text: 'ten', betont: false },
    ],
    versfuss: 'Jambus (5-hebig, mit Variationen)',
    wirkung:
      'Der fünfhebige Jambus (Blankvers-Nähe) verleiht dem Vers eine getragene, elegische Stimmung. Trakls metrische Variationen (aufgelöste Senkungen) erzeugen eine unterschwellige Unruhe, die zur Thematik des Verfalls passt.',
    quelle: 'Trakl: „Verfall" (1913) — Expressionismus',
  },
];
...
export const reimschemaStrophen = [
  ...
  {
    strophe: [
      { id: 'rs3-v1', text: 'Die Luft ging durch die Felder,', reimBuchstabe: 'a' },
      { id: 'rs3-v2', text: 'Die Ähren wogten sacht,', reimBuchstabe: 'b' },
      { id: 'rs3-v3', text: 'Es rauschten leis die Wälder,', reimBuchstabe: 'a' },
      { id: 'rs3-v4', text: 'So sternklar war die Nacht.', reimBuchstabe: 'b' },
    ],
    reimschemaName: 'Kreuzreim',
    erklaerung:
      'Kreuzreim (abab): „Felder" reimt auf „Wälder" (a, reiner Reim) und „sacht" auf „Nacht" (b, reiner Reim). Der regelmäßige Kreuzreim stützt die ruhige, fließende Stimmung der Mondnacht.',
  },
];
